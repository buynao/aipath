...
export const lessons = [
  // ---------- 第一阶段 · 直觉篇 ----------
  { id: 1, slug: '01-ai-ml-dl', stage: 0, level: lv.intro, dots: 1, tags: [sky], ready: true, minutes: 11,
  ...
  { id: 2, slug: '02-how-machines-learn', stage: 0, level: lv.intro, dots: 1, tags: [], ready: true, minutes: 20,
  ...
  { id: 3, slug: '03-a-single-neuron', stage: 0, level: lv.intro, dots: 2, tags: [sky], ready: true, minutes: 10,
  ...
  { id: 4, slug: '04-gradient-descent', stage: 0, level: lv.basic, dots: 2, tags: [terra, sky], ready: true, minutes: 16,
  ...
  { id: 5, slug: '05-data-and-overfitting', stage: 0, level: lv.basic, dots: 2, tags: [amber], ready: true, minutes: 13,
  ...
  // ---------- 第二阶段 · 原理篇 ----------
  { id: 6, slug: '06-deep-networks-backprop', stage: 1, level: lv.basic, dots: 2, tags: [], ready: true, minutes: 24,
  ...
  { id: 7, slug: '07-cnn-how-computers-see', stage: 1, level: lv.basic, dots: 2, tags: [sky], ready: true, minutes: 10,
  ...
  { id: 8, slug: '08-embeddings-vector-space', stage: 1, level: lv.adv, dots: 3, tags: [terra, sky], ready: true, minutes: 26,
  ...
  { id: 9, slug: '09-attention', stage: 1, level: lv.adv, dots: 3, tags: [terra], ready: true, minutes: 28,
  ...
  { id: 10, slug: '10-transformer', stage: 1, level: lv.adv, dots: 3, tags: [sky], ready: true, minutes: 27,
  ...
  // ---------- 第三阶段 · 大模型篇 ----------
  { id: 11, slug: '11-tokens', stage: 2, level: lv.basic, dots: 2, tags: [sky], ready: true, minutes: 19,
  ...
  { id: 12, slug: '12-pretraining', stage: 2, level: lv.basic, dots: 2, tags: [], ready: true, minutes: 25,
  ...
  { id: 13, slug: '13-sft-rlhf', stage: 2, level: lv.adv, dots: 3, tags: [], ready: true, minutes: 30,
  ...
  { id: 14, slug: '14-temperature-sampling', stage: 2, level: lv.basic, dots: 2, tags: [amber, sky], ready: true, minutes: 16,
  ...
  { id: 15, slug: '15-scaling-laws', stage: 2, level: lv.adv, dots: 2, tags: [sky], ready: true, minutes: 20,
  ...
  // ---------- 第四阶段 · 应用篇 ----------
  { id: 16, slug: '16-prompt-engineering', stage: 3, level: lv.basic, dots: 2, tags: [], ready: true, minutes: 25,
  ...
  { id: 17, slug: '17-context-window', stage: 3, level: lv.basic, dots: 2, tags: [amber], ready: true, minutes: 18,
  ...
  { id: 20, slug: '20-agents', stage: 3, level: lv.adv, dots: 3, tags: [], ready: true, minutes: 20,
  ...
  // ---------- 第五阶段 · 前沿篇 ----------
  { id: 21, slug: '21-diffusion-models', stage: 4, level: lv.adv, dots: 3, tags: [sky], ready: true, minutes: 12,
  ...
  { id: 22, slug: '22-multimodal', stage: 4, level: lv.adv, dots: 2, tags: [], ready: true, minutes: 19,
  ...
  { id: 23, slug: '23-reasoning-models', stage: 4, level: lv.adv, dots: 2, tags: [], ready: true, minutes: 19,
  ...
  { id: 24, slug: '24-mcp-ecosystem', stage: 4, level: lv.adv, dots: 2, tags: [], ready: true, minutes: 12,
  ...
  { id: 25, slug: '25-open-vs-closed', stage: 4, level: lv.intro, dots: 1, tags: [], ready: true, minutes: 16,
  ...
  // ---------- 第六阶段 · 实战篇 ----------
  { id: 26, slug: '26-first-api-call', stage: 5, level: lv.basic, dots: 2, tags: [], ready: true, minutes: 18,
  ...
  { id: 27, slug: '27-local-llms', stage: 5, level: lv.basic, dots: 2, tags: [], ready: true, minutes: 15,
  ...
  { id: 28, slug: '28-build-rag', stage: 5, level: lv.adv, dots: 3, tags: [], ready: true, minutes: 17,
  ...
  { id: 29, slug: '29-evals-and-safety', stage: 5, level: lv.adv, dots: 2, tags: [], ready: true, minutes: 15,
